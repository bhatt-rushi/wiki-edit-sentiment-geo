...
*   **AI Context View**: Displays the specific window of text (approximately +/- 500 characters around the edit) that was passed to the AI models for analysis. This context helps explain why a specific Topic or Stance was predicted. The specific change (insertion or modification) is highlighted in green.
