...
*   `J/K` (Shift+j/k): Scroll the AI Context view.
*   `q`: Quit.
...
*   **AI Context View**: Displays the specific window of text (equal to the length of the diff around the edit) that was passed to the AI models for analysis. This context helps explain why a specific Topic or Stance was predicted. The specific change (insertion or modification) is highlighted in green.
